...
start_date = datetime.datetime(2000, 1, 1)  # Replace with your desired start date
end_date = datetime.datetime(2023, 11, 28)  # Replace with your desired end date

savings_rate = pdr.DataReader('PSAVERT', 'fred', start_date, end_date)  # Household savings rate
