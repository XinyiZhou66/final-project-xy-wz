...
file_path = '/Users/wuzhenhan/Desktop/anunemp.csv'
...
gdf_merged_2023.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2023.plot(column='Rate_2023', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                     legend_kwds={'label': "Unemployment Rate in 2023 (%)",
                                  'shrink': 0.6},
                     vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2023)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
gdf_merged_2022.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2022.plot(column='Rate_2022', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                     legend_kwds={'label': "Unemployment Rate in 2022 (%)",
                                  'shrink': 0.6},
                     vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2022)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
gdf_merged_2021 = gdf_states.merge(unemployment_data_filtered, how='left', left_on='NAME', right_on='State')
gdf_merged_2021['Rate_2021'] = gdf_merged_2021['Rate_2021'].fillna(0)

fig, ax = plt.subplots(1, 1, figsize=(20, 15))

gdf_merged_2021.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2021.plot(column='Rate_2021', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                legend_kwds={'label': "Unemployment Rate in 2021 (%)",
                             'shrink': 0.6},
                vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2021)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
top_3_states_2021 = gdf_merged_2021.nlargest(3, 'Rate_2021')[['NAME', 'Rate_2021']]
...
gdf_merged_2020 = gdf_states.merge(unemployment_data_filtered, how='left', left_on='NAME', right_on='State').copy()
gdf_merged_2020['Rate_2020'] = gdf_merged_2020['Rate_2020'].fillna(0)

fig, ax = plt.subplots(1, 1, figsize=(20, 15))

gdf_merged_2020.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2020.plot(column='Rate_2020', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                legend_kwds={'label': "Unemployment Rate in 2020 (%)",
                             'shrink': 0.6},
                vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2020)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
top_3_states_2020 = gdf_merged_2020.nlargest(3, 'Rate_2020')[['NAME', 'Rate_2020']]
print(top_3_states_2020)

gdf_merged_2019 = gdf_states.merge(unemployment_data_filtered, how='left', left_on='NAME', right_on='State').copy()
gdf_merged_2019['Rate_2019'] = gdf_merged_2019['Rate_2019'].fillna(0)

fig, ax = plt.subplots(1, 1, figsize=(20, 15))

gdf_merged_2019.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2019.plot(column='Rate_2019', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                legend_kwds={'label': "Unemployment Rate in 2019 (%)",
                             'shrink': 0.6},
                vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2019)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
top_3_states_2019 = gdf_merged_2019.nlargest(3, 'Rate_2019')[['NAME', 'Rate_2019']]
print(top_3_states_2019)

gdf_merged_2018 = gdf_states.merge(unemployment_data_filtered, how='left', left_on='NAME', right_on='State').copy()
gdf_merged_2018['Rate_2018'] = gdf_merged_2018['Rate_2018'].fillna(0)

fig, ax = plt.subplots(1, 1, figsize=(20, 15))

gdf_merged_2018.boundary.plot(ax=ax, linewidth=1, edgecolor='black')
gdf_merged_2018.plot(column='Rate_2018', cmap='OrRd', linewidth=0.8, ax=ax, edgecolor='black', legend=True,
                legend_kwds={'label': "Unemployment Rate in 2018 (%)",
                             'shrink': 0.6},
                vmin=0, vmax=10)

plt.title('Unemployment Rate by State (2018)', fontsize=20)
plt.axis('off')
ax.set_aspect('equal')
ax.set_xlim(-180, -50)
ax.set_ylim(15, 75)
...
top_3_states_2018 = gdf_merged_2018.nlargest(3, 'Rate_2018')[['NAME', 'Rate_2018']]
